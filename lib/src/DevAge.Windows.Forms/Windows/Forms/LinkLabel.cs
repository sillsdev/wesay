...
namespace DevAge.Windows.Forms
{
	...
	public class LinkLabel : System.Windows.Forms.UserControl
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			Drawing.Utilities.DrawTextAndImage(e.Graphics, contentRect, image, mImageAlignment, mImageStretch, disabledImage, Text, mStringFormat, mAlignTextToImage, ForeColor, Font, Enabled == false);
		}
