...
namespace DevAge.Windows.Forms
{
	...
	{
		private DevAge.Windows.Forms.Button btMain;
		...
		private void InitializeComponent()
		{
			...
			this.btMain = new DevAge.Windows.Forms.Button();
		...
		[Browsable(true)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		public virtual DevAge.Drawing.ContentAlignment TextAlign
		{
		...
		[Browsable(true)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		public virtual DevAge.Drawing.ContentAlignment ImageAlign
		{
