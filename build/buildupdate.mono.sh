...
#     paths: {"release/**"=>"lib/Release", "debug/**"=>"lib/Debug", "Autofac.dll"=>"lib/common", "Mercurial-i686.zip"=>"lib/common", "Mercurial-x86_64.zip"=>"lib/common"}
...
#     clean: false
#     revision: latest.lastSuccessful
#     paths: {"L10NSharp.dll"=>"lib/common", "L10NSharp.dll.mdb"=>"lib/common"}
#     VCS: https://bitbucket.org/hatton/l10nsharp [default]
# [2] build: palaso-precise64-develop-continuous (bt334)
#     project: libpalaso
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt337/latest.lastSuccessful/Autofac.dll ../lib/common/Autofac.dll
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt271/latest.lastSuccessful/L10NSharp.dll.mdb ../lib/common/L10NSharp.dll.mdb
