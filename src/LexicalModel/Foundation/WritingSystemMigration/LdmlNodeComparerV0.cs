...
namespace WeSay.LexicalModel.Foundation.WritingSystemMigration
{
	...
	/// </summary>
	class PalasoLdmlNodeComparerV0 : IComparer<XmlNode>
	{
		public static PalasoLdmlNodeComparerV0 Singleton
		{
			get
			{
				if (_singleton == null)
				{
					_singleton = new PalasoLdmlNodeComparerV0();
				}
				return _singleton;
			}
		}

		private static PalasoLdmlNodeComparerV0 _singleton;
		private PalasoLdmlNodeComparerV0() { }
