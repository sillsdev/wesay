...
{
	public class PalasoLdmlAdaptorV0
	{
		private XmlNamespaceManager _nameSpaceManager;

		public PalasoLdmlAdaptorV0()
		{
			_nameSpaceManager = MakeNameSpaceManager();
		}

		public void Read(string filePath, PalasoWritingSystemDefinitionV0 ws)
		{
			if (filePath == null)
			{
		...
		public void Read(XmlReader xmlReader, PalasoWritingSystemDefinitionV0 ws)
		{
			if (xmlReader == null)
			{
		...
		{
			return XmlHelpers.FindElement(reader, name, PalasoLdmlNodeComparerV0.CompareElementNames);
		}

		private static bool FindElement(XmlReader reader, string name, string nameSpace)
		{
			return XmlHelpers.FindElement(reader, name, nameSpace, PalasoLdmlNodeComparerV0.CompareElementNames);
		}
		...
		private void ReadLdml(XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
		...
		protected virtual void ReadTopLevelSpecialElement(XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
		...
		private void ReadIdentityElement(XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
		...
		private void ReadLayoutElement(XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
		...
		private void ReadCollationsElement(XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
		...
		private void ReadCollationElement(string collationXml, PalasoWritingSystemDefinitionV0 ws)
		{
			...
			PalasoWritingSystemDefinitionV0.SortRulesType rulesType = PalasoWritingSystemDefinitionV0.SortRulesType.OtherLanguage;
			using (XmlReader collationReader = XmlReader.Create(new StringReader(collationXml), readerSettings))
			{
				...
				ws.SortUsing = (PalasoWritingSystemDefinitionV0.SortRulesType)Enum.Parse(typeof(PalasoWritingSystemDefinitionV0.SortRulesType), rulesTypeAsString);
			}
			switch (ws.SortUsing)
			{
				case PalasoWritingSystemDefinitionV0.SortRulesType.OtherLanguage:
					ReadCollationRulesForOtherLanguage(collationXml, ws);
					break;
				case PalasoWritingSystemDefinitionV0.SortRulesType.CustomSimple:
					ReadCollationRulesForCustomSimple(collationXml, ws);
					break;
				case PalasoWritingSystemDefinitionV0.SortRulesType.CustomICU:
		...
		private void ReadCollationRulesForOtherLanguage(string collationXml, PalasoWritingSystemDefinitionV0 ws)
		{
			XmlReaderSettings readerSettings = new XmlReaderSettings();
			readerSettings.CloseInput = true;
			readerSettings.ConformanceLevel = ConformanceLevel.Fragment;
			using (XmlReader collationReader = XmlReader.Create(new StringReader(collationXml), readerSettings))
			{
				...
				if (!foundValue)
				{
					...
					ws.SortUsing = PalasoWritingSystemDefinitionV0.SortRulesType.CustomICU;
					ReadCollationRulesForCustomICU(collationXml, ws);
				}
			}
		}

		private void ReadCollationRulesForCustomICU(string collationXml, PalasoWritingSystemDefinitionV0 ws)
		{
			ws.SortRules = LdmlCollationParser.GetIcuRulesFromCollationNode(collationXml);
		}

		private void ReadCollationRulesForCustomSimple(string collationXml, PalasoWritingSystemDefinitionV0 ws)
		{
			string rules;
		...
		public void Write(string filePath, PalasoWritingSystemDefinitionV0 ws, Stream oldFile)
		{
			if (filePath == null)
			{
				throw new ArgumentNullException("filePath");
		...
		public void Write(XmlWriter xmlWriter, PalasoWritingSystemDefinitionV0 ws, XmlReader xmlReader)
		{
			if (xmlWriter == null)
			{
		...
		private void WriteLdml(XmlWriter writer, XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
		...
		private void CopyUntilElement(XmlWriter writer, XmlReader reader, string elementName)
		{
			...
			while (!reader.EOF && reader.NodeType != XmlNodeType.EndElement
				   && (reader.NodeType != XmlNodeType.Element || PalasoLdmlNodeComparerV0.CompareElementNames(reader.Name, elementName) < 0))
			{
		...
		public void FillWithDefaults(string rfc4646, PalasoWritingSystemDefinitionV0 ws)
		{
		...
		private void WriteIdentityElement(XmlWriter writer, XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
			Debug.Assert(writer != null);
			Debug.Assert(ws != null);
		...
		private void WriteLayoutElement(XmlWriter writer, XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
			Debug.Assert(writer != null);
			Debug.Assert(ws != null);
			bool needToCopy = reader != null && reader.NodeType == XmlNodeType.Element && reader.Name == "identity";
		...
		protected virtual void WriteTopLevelSpecialElements(XmlWriter writer, PalasoWritingSystemDefinitionV0 ws)
		{
		...
		private void WriteCollationsElement(XmlWriter writer, XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
			Debug.Assert(writer != null);
			Debug.Assert(ws != null);
		...
		private void WriteCollationElement(XmlWriter writer, XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
			Debug.Assert(writer != null);
			Debug.Assert(ws != null);
			...
			if (ws.SortUsing == PalasoWritingSystemDefinitionV0.SortRulesType.DefaultOrdering && !needToCopy)
				return;
			...
			if (ws.SortUsing != PalasoWritingSystemDefinitionV0.SortRulesType.DefaultOrdering)
			{
		...
		private void WriteCollationRulesFromOtherLanguage(XmlWriter writer, XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
			Debug.Assert(writer != null);
			Debug.Assert(ws != null);
			Debug.Assert(ws.SortUsing == PalasoWritingSystemDefinitionV0.SortRulesType.OtherLanguage);
		...
		private void WriteCollationRulesFromCustomSimple(XmlWriter writer, XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
			Debug.Assert(writer != null);
			Debug.Assert(ws != null);
			Debug.Assert(ws.SortUsing == PalasoWritingSystemDefinitionV0.SortRulesType.CustomSimple);
		...
		private void WriteCollationRulesFromCustomICU(XmlWriter writer, XmlReader reader, PalasoWritingSystemDefinitionV0 ws)
		{
			Debug.Assert(writer != null);
			Debug.Assert(ws != null);
			Debug.Assert(ws.SortUsing == PalasoWritingSystemDefinitionV0.SortRulesType.CustomICU);
		...
		private class WritingSystemV0DefinitionForValidationChecking : PalasoWritingSystemDefinitionV0
		{
