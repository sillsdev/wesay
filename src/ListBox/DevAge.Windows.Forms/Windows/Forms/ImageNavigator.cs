...
namespace DevAge.Windows.Forms
{
	...
	public class ImageNavigator : System.Windows.Forms.UserControl
	{
		...
		private DevAge.Windows.Forms.Button btNext;
		private DevAge.Windows.Forms.Button btPrevious;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.btNext = new DevAge.Windows.Forms.Button();
			this.btPrevious = new DevAge.Windows.Forms.Button();
			...
			this.btNext.ImageAlign = DevAge.Drawing.ContentAlignment.MiddleLeft;
			...
			this.btNext.TextAlign = DevAge.Drawing.ContentAlignment.MiddleCenter;
			...
			this.btPrevious.ImageAlign = DevAge.Drawing.ContentAlignment.MiddleLeft;
			...
			this.btPrevious.TextAlign = DevAge.Drawing.ContentAlignment.MiddleCenter;
