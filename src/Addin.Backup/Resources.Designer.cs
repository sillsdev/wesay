...
namespace Addin.Backup
{
	...
	internal class Resources
	{
			...
			get
			{
				if (ReferenceEquals(resourceMan, null))
				{
					ResourceManager temp =
							new ResourceManager("Addin.Backup.Resources",
		...
		internal static Bitmap backupToDeviceImage
		{
			get
			{
		...
		internal static Bitmap emailProjectImage
		{
			get
			{
		...
		internal static Bitmap greenEmail
		{
			get
			{
		...
		internal static Bitmap greenSynchronize
		{
			get
			{
		...
		internal static Bitmap greenUsbKey
		{
			get
			{
