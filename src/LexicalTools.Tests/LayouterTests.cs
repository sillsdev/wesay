...
namespace WeSay.LexicalTools.Tests
{
	...
	public class LayouterTests
	{
		...
		{
			Assert.Throws<ArgumentNullException>(() => new LexEntryLayouter(null, 0, new ViewTemplate(), null, Context, new LexEntry(), false));
		}
		...
		public void Create_NullviewTemplate_Throws()
		{
			...
			{
				Assert.Throws<ArgumentNullException>(() => new LexEntryLayouter(detailList, 0, null, null, Context, new LexEntry(), false));
			}
		}
		...
		public void EmptyViewTemplate()
		{
			...
			{
				LexEntryLayouter layout = new LexEntryLayouter(dl, 0, new ViewTemplate(), null, Context, entry, false);
				layout.AddWidgets();
		...
		private DetailList MakeDetailList(bool showNormallyHiddenFields, ViewTemplate template)
		{
			...
			LexEntryLayouter layout = new LexEntryLayouter(dl, 0, template, null, Context, entry, false);
