...
namespace GraphComponents
{
	...
	public class Plotter : Graph
	{
		...
		private System.Windows.Forms.HScrollBar plotterHScrollBar;
		/// <summary>
		...
		/// </summary>
		Point mouseHoverCoordinates = new Point ();
		...
		private System.Windows.Forms.Button buttonPrevChannel;
		private System.Windows.Forms.Button buttonNextChannel;
		private System.Windows.Forms.Button buttonUpperYPlus;
		private System.Windows.Forms.Button buttonUpperYMinus;
		...
		private void InitializeComponent()
		{
			...
			this.plotterHScrollBar.Scroll += new System.Windows.Forms.ScrollEventHandler(this.plotterHScrollBar_Scroll);
			//
			// buttonPrevChannel
			//
			...
			this.buttonPrevChannel.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.buttonNextChannel.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.buttonUpperYPlus.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.buttonUpperYMinus.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
		...
		private void DrawLimitChangingButtons ()
		{
			...
			buttonUpperYPlus.Top   = buttonPrevChannel.Bottom + 2; // 2 pixels after the prev channel button
		...
		private Point GetPixelFromValue (Channel channel, int XinValue, float YinValue)
		{
			...
			int yInPixel     = GraphArea.Bottom - (int) (y * (float) GraphArea.Height);
		...
		{
			float yAbsolute    = (float) (GraphArea.Bottom - YInPixel) / (float) GraphArea.Height;
			float yRange       = channel.MaximumValue - channel.MinimumValue;

			float yInValue     = channel.MinimumValue + (yAbsolute * yRange);
			int xRangeInMs     = (int) (xRange.Duration ().Ticks / TimeSpan.TicksPerMillisecond);
			float xOffsetPixel = (float) (XInPixel - GraphArea.Left) / (float) GraphArea.Width;
		...
		public void Stop ()
		{
			...
			plotterHScrollBar.Maximum = pointsToRemove + plotterHScrollBar.LargeChange; // TODO: Figure out how this works
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void plotterHScrollBar_Scroll(object sender, System.Windows.Forms.ScrollEventArgs e)
		{
		...
		private void DrawCrossHair (Graphics graphics)
		{
			...
			if (mouseHoverCoordinates.X < GraphArea.Left || mouseHoverCoordinates.X > GraphArea.Right)
				return;

			if (mouseHoverCoordinates.Y < GraphArea.Top || mouseHoverCoordinates.Y > GraphArea.Bottom)
				return;
			...
			// vertical
			graphics.DrawLine (crossHairPen, mouseHoverCoordinates.X, GraphArea.Top, mouseHoverCoordinates.X, GraphArea.Bottom);
		...
		private void DrawYAxisValues (Graphics graphics)
		{
			...
			float graduationDiff = (ActiveChannel.MaximumValue - ActiveChannel.MinimumValue) / GraduationsY;
		...
		private void DrawXAxisValues (Graphics graphics)
		{
			...
			for (int i = 0; i <= GraduationsX; i ++)
			{
				...
				RectangleF axisValuesRect = new RectangleF (offset - numberSize.Width / 2, GraphArea.Bottom + 4, numberSize.Width, Font.Height);
		...
		private string GetFormatForTime (int timeInMilisecond)
		{
			...
			switch (timeDisplayStyle)
			{
				case TimeAxisStyle.Millisecond:
					timeValue = string.Format (CultureInfo.CurrentUICulture, "{0:G}", timeInMilisecond);
					break;
				case TimeAxisStyle.MillisecondWithUnitDisplay:
					timeValue = string.Format (CultureInfo.CurrentUICulture, "{0:G}ms", timeInMilisecond);
					break;
				case TimeAxisStyle.Second:
					timeValue = string.Format (CultureInfo.CurrentUICulture, "{0:D2}:{1:D3}", timeInMilisecond / 1000, timeInMilisecond % 1000);
					break;
				case TimeAxisStyle.SecondWithUnitDisplay:
					timeValue = string.Format (CultureInfo.CurrentUICulture, "{0:D2}:{1:D3}s", timeInMilisecond / 1000, timeInMilisecond % 1000);
					break;

				case TimeAxisStyle.Smart:
					if (plotRate < 1000)
					{
						TimeSpan t = new TimeSpan (timeInMilisecond * TimeSpan.TicksPerMillisecond);
					...
					else
					{
						...
						else if (timeInMilisecond >= 60000 && timeInMilisecond < 3600000)
						{
							...
							timeValue = string.Format (CultureInfo.CurrentUICulture, "{0}:{1:D2}", min, sec);
						}
						else if (timeInMilisecond >= 3600000)
						{
							int tempTime = timeInMilisecond / 1000;
							...
							timeValue = string.Format (CultureInfo.CurrentUICulture, "{0}:{1:D2}:{2:D2}", hr, min, sec);
						}
					}
					break;
			}
		...
		private void buttonNextChannel_Click(object sender, System.EventArgs e)
		{
			NextChannel ();
		}

		private void buttonPrevChannel_Click(object sender, System.EventArgs e)
		{
			PreviousChannel ();
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void buttonUpperYPlus_Click(object sender, System.EventArgs e)
		{
			// raise graph by 5%
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void buttonUpperYMinus_Click(object sender, System.EventArgs e)
		{
			// reduce graph by 5%
			float graduationDiff = (ActiveChannel.MaximumValue - ActiveChannel.MinimumValue) / 20;
			ActiveChannel.MaximumValue -= graduationDiff;
