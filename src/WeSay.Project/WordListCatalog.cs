...
namespace WeSay.Project
{
	...
	public class WordListCatalog : Dictionary<string, WordListDescription>
	{
		public WordListCatalog()
		{
			...
			Add("SILCAWL", new WordListDescription("en", "SIL-CAWL ", "SIL-CAWL", "Collect new words by translating from the SIL Comparative African Wordlist. This is a list of 1700 words which includes semantic domains, parts of speech, and glosses in several languages. You can use one of several languages for prompting: French, Portuguese, Swahili, Hausa, and more."
				+ Environment.NewLine + Environment.NewLine
				+"WeSay will use the top-most writing system of the definition field to choose the prompting language."));
