...
//    public class MyCachedSortedDb4oList<K, T> : IBindingList, IEnumerable<K>, IDisposable where T : class, new()
//    {
//        public delegate K KeyProvider(T item);

//        private List<RecordToken> _keyIdMap;
//        private List<RecordToken> _idKeyMap;
//        private Db4oRecordList<T> _masterRecordList;
//        private readonly string _cachePath;
//        private readonly KeyValueComparer<string, long> _keyIdSorter;
//        private readonly KeyValueComparer<string, long> _idKeySorter;
//        private readonly ISortHelper<T> _sortHelper;

//        internal MyCachedSortedDb4oList(Db4oRecordListManager recordListManager, ISortHelper<T> sortHelper)
//        {
...
//            _keyIdSorter =
//                    new KeyValueComparer<string, long>(sortHelper.KeyComparer,
...
//                            {
//                                _keyIdMap = (List<RecordToken>)formatter.Deserialize(fs);
//                                _idKeyMap = new List<RecordToken>(_keyIdMap);
...
//        {
//            private MyCachedSortedDb4oList<K, T> _collection;
//            private int _index;
//            private bool _isDisposed;

//            public Enumerator(MyCachedSortedDb4oList<K, T> collection)
//            {
//                if (collection == null)
//                {
