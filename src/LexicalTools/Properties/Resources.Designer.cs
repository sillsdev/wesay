...
namespace WeSay.LexicalTools.Properties
{
	...
	internal class Resources
	{
			...
			get
			{
				if (ReferenceEquals(resourceMan, null))
				{
					ResourceManager temp =
							new ResourceManager("WeSay.LexicalTools.Properties.Resources",
		...
		internal static Bitmap blueDictionary
		{
			get
			{
		...
		internal static Bitmap DeleteWord
		{
			get
			{
		...
		internal static Bitmap NewWord
		{
			get
			{
