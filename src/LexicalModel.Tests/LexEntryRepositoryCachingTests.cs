...
namespace WeSay.LexicalModel.Tests
{
	...
	public class LexEntryRepositoryCachingTests
	{
		...
		public void GetAllEntriesSortedByHeadWord_CreateItemAfterFirstCall_EntryIsReturnedAndSortedInResultSet()
		{
			...
			_repository.GetAllEntriesSortedByHeadword(WritingSystem.FromRFC5646("de"));

			LexEntry entryAfterFirstQuery = _repository.CreateItem();

			ResultSet<LexEntry> results = _repository.GetAllEntriesSortedByHeadword(WritingSystem.FromRFC5646("de"));
		...
		public void GetAllEntriesSortedByLexicalForm_CreateItemAfterFirstCall_EntryIsReturnedAndSortedInResultSet()
		{
			...
			_repository.GetAllEntriesSortedByLexicalFormOrAlternative(WritingSystem.FromRFC5646("de"));

			LexEntry entryAfterFirstQuery = _repository.CreateItem();

			ResultSet<LexEntry> results = _repository.GetAllEntriesSortedByLexicalFormOrAlternative(WritingSystem.FromRFC5646("de"));
			Assert.AreEqual(2, results.Count);
			Assert.AreEqual(null, results[0]["Form"]);
			Assert.AreEqual("word 1", results[1]["Form"]);
		}
		...
		public void NotifyThatLexEntryHasBeenUpdated_LexEntry_CachesAreUpdated()
		{
			...
			WritingSystem writingSystemToMatch = WritingSystem.FromRFC5646("de");
		...
		public void GetEntriesWithMissingFieldSortedByLexicalUnit_CreateItemAfterFirstCall_EntryIsReturnedAndSortedInResultSet()
		{
			...
			_repository.GetEntriesWithMissingFieldSortedByLexicalUnit(fieldToFill, null, WritingSystem.FromRFC5646("de"));

			LexEntry entryAfterFirstQuery = _repository.CreateItem();

			ResultSet<LexEntry> results = _repository.GetEntriesWithMissingFieldSortedByLexicalUnit(fieldToFill, null, WritingSystem.FromRFC5646("de"));
			Assert.AreEqual(2, results.Count);
			Assert.AreEqual(null, results[0]["Form"]);
			Assert.AreEqual("word 1", results[1]["Form"]);
		}
		...
		public void GetAllEntriesSortedByDefinition_CreateItemAfterFirstCall_EntryIsReturnedAndSortedInResultSet()
		{
			...
			_repository.GetAllEntriesSortedByDefinitionOrGloss(WritingSystem.FromRFC5646("de"));

			LexEntry entryAfterFirstQuery = CreateEntryWithDefinitionBeforeFirstQuery("de", "word 2");

			ResultSet<LexEntry> results = _repository.GetAllEntriesSortedByDefinitionOrGloss(WritingSystem.FromRFC5646("de"));
			Assert.AreEqual(2, results.Count);
			Assert.AreEqual("word 1", results[0]["Form"]);
