...
//        {
//            LexEntrySortHelper h = new LexEntrySortHelper(((LexEntryRepository)_lexEntryRepository).DataSource, _writingSystem, true);
//            Assert.IsNotNull(h);
//        }
...
//        {
//            new LexEntrySortHelper(((LexEntryRepository)_lexEntryRepository).DataSource, null, true);
//        }

//        [Test]
//        public void GetKeys_ForGloss_LexEntryHasNoSenses_NotEmpty()
//        {
//            LexEntrySortHelper h = new LexEntrySortHelper(((LexEntryRepository)_lexEntryRepository).DataSource, _writingSystem, false);
//            int count = 0;
...
//            entriesList = (Db4oRecordList<LexEntry>) _lexEntryRepository.GetListOfType<LexEntry>();
//            entriesList.Add(e);
//            long entryId = ((LexEntryRepository)_lexEntryRepository).DataSource.Data.Ext().GetID(e);
