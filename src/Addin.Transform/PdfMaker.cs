...
namespace Addin.Transform
{
	...
	public class PdfMaker : HtmlTransformer
	{
		public override string LocalizedName
		{
			get
			{
				return StringCatalog.Get("~Make Pdf Dictionary");
			}
		}
		...
		public override Image ButtonImage
		{
			get
			{
				return Resources.pdfDictionary;
			}
		}
		...
		public override void Launch(Form parentForm, ProjectInfo projectInfo)
		{
			...
			try
			{
				string pdfPath = Path.Combine(projectInfo.PathToExportDirectory, projectInfo.Name + ".pdf");

				string layoutCssPath = projectInfo.LocateFile(Path.Combine("Templates", "basicDictionary.css"));
